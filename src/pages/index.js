...
return (
  <div className='w-full relativ'>
    ...
    <div className='loader w-full h-screen fixed top-0 left-0 bg-white z-[999] flex items-center justify-center flex-col'>
      ...
      <h4 className='loader-text font-[font2] uppercase text-[#DE1F26] sm:text-[10vw] md:text-[7vw] lg:text-[4.5vw] whitespace-nowrap text-[3vw] font-semibold opacity-0'>THR India Wrapped 2024
      </h4>
    </div>

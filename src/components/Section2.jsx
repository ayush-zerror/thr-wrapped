...
const Section2 = ({ videoCover, footer }) => {
  ...
  return (
    <div ref={container} className='w-full min-h-screen py-[5vw]'>
      {data.map((d, i) => (<div ref={(el) => wrappers.current[i] = el} key={i} className='wrap w-full sm:h-[260px] md:h-[80%] lg:h-[42vh] overflow-hidden  xl:h-[100%]  h-[80%] flex items-start justify-between relative'>
        ...
        <div className="card sm:hidden md:hidden p-[3vw] py-[3vw] w-[calc(100%/3)] h-full relative text-white">
          ...
          <div className="line1l sm:h-[260px] md:h-[80%] lg:h-[42vh] xl:h-[200%] h-[100vh] w-[1px] bg-white/80 absolute right-0 top-0"></div>
        </div>
        <div style={{ transformOrigin: "top center" }} className="card  card-center relative sm:w-[50%] md:w-[50%] w-[calc(100%/3)] sm:h-[260px] md:h-[80%] lg:h-[80%]  h-full">
        ...
        <div className="card  sm:w-[50%]  md:w-[50%] w-[calc(100%/3)]  relative text-white">
          <div className="line1r sm:h-[260px] md:h-[120%] lg:h-[42vh] xl:h-[200%] h-[100vh] w-[1px] bg-white/80 absolute left-0 top-0"></div>
          <div className='card-content scrollstyle  p-[3vw] py-[3vw] sm:h-[260px] md:h-[80%] lg:h-[80%] xl:h-[100%]  overflow-y-scroll overflow-hidden pointer-events-none'>

        ...
        <div ref={footer} className='footer w-full h-screen relative'>
            <div className='overlay w-full h-full  absolute top-0 left-0 flex flex-col items-center text-white justify-between text-center p-[1.5vw] sm:pt-[15vh] sm:py-[8vw]'>
                ...
                <div className='text-center'>
                    ...
                    <h5 className='sm:text-[4vw] md:text-[2vw] sm:font-normal sm:block md:block hidden text-[.98vw] uppercase font-[font3] font-medium'>Janpath Lane, New Delhi - 110001.</h5>
                    <h5 className='sm:text-[4vw] md:text-[2vw] lg:text-[1.5vw] sm:font-normal  text-[.98vw] uppercase font-[font3] font-medium flex gap-[2vw] justify-center'>
                    ...
                    <h5 className='sm:hidden md:hidden  text-[.98vw] lg:text-[1.5vw] mt-[2.5vw] uppercase font-[font3] font-medium flex gap-[2vw] justify-center'><a href='https://www.hollywoodreporterindia.com/privacy-policy' target='_block'>Privacy Policy</a>

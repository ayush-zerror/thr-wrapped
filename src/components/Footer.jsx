...
const Footer = ({footer}) => {
    return (
        <div ref={footer} className='footer w-full h-screen relative'>
            <div className='overlay w-full h-full  absolute top-0 left-0 flex flex-col items-center mix-blend-difference text-white justify-between text-center p-[1.5vw] sm:pt-[15vh] sm:py-[8vw]'>
                ...
                <div className='text-center'>
                    ...
                    <h5 className='sm:text-[4vw] sm:font-normal sm:block hidden text-[.98vw] uppercase font-[font3] font-medium'>RPSG Lifestyle Media Thapar House, 3rd floor,</h5>
                    <h5 className='sm:text-[4vw] sm:font-normal sm:block hidden text-[.98vw] uppercase font-[font3] font-medium'>Janpath Lane, New Delhi - 110001.</h5>
                    ...
                    <a href='https://www.hollywoodreporterindia.com/privacy-policy'  target='_block' className='sm:text-[4vw] sm:font-normal sm:mt-[10vw] sm:block hidden text-[.98vw] uppercase font-[font3] font-medium'>Privacy Policy</a>
                    ...
                    <h5 className='sm:text-[4vw] sm:font-normal sm:block hidden text-[.98vw] uppercase font-[font3] font-medium'>© 2025 The Hollywood Reporter, LLC.</h5>

...
const Footer = ({ footer }) => {
    return (
        <div ref={footer} className='footer w-full h-screen relative'>
            <div className='overlay w-full h-full  absolute top-0 left-0 flex flex-col items-center text-white justify-between text-center p-[1.5vw] sm:pt-[8vh] sm:py-[8vw]'>
